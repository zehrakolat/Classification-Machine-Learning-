...
•	Geniş Model Yelpazesi: * Temel Modeller: Logistic Regression, Naive Bayes, SVM.
...
Random Forest	0.61	                0.52	            Eğitim setinde %92 F1 başarısına rağmen yüksek aşırı öğrenme (overfitting).
